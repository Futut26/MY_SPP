                    ...
                    <div class="row" id="table-hover-row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="d-flex col-lg-6 mb-3" action="<?= BASE_URL;?>/admin/cariSiswaTagihan" method="post">
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <?php foreach ($data['siswa'] as $sws) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $sws['jurusan'] ?></td>
                                                    <td><a class="btn btn-info btn-sm" href="<?=BASE_URL;?>/admin/tagihanSiswa/<?=$sws['nisn'];?>">Lihat Tagihan</a></td>
                                                </tr>
                                            <?php endforeach ;?>
                                            </tbody>
                                        </table>
